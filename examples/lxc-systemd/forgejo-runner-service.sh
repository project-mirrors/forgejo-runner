...
DEFAULT_RUNNER_VERSION=13.2.0 # renovate: datasource=forgejo-releases depName=forgejo/runner
...
YQ_VERSION=v4.53.6 # renovate: datasource=github-releases depName=forgejo-runner-service-yq packageName=mikefarah/yq
SELF=${BASH_SOURCE[0]}
