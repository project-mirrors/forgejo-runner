...
// runnerLogPrefix is prepended to error messages generated by forgejo-runner itself (as opposed to step output) to
// clearly distinguish runner-generated text from actual step output in the UI logs.
const runnerLogPrefix = "\u2699\ufe0f [runner]:"
